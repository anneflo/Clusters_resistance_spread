...
function [endTest_list] = BP_two_types_det(Nit, N_gen, N_host, N_bs, lambda_i, lambda_n, q_i, q_n, frac, n, fs, fr, mu1, tau)
    ...
    for Index = 1 : Nit
        ...
        while gen <= N_gen-1 && endTest == 0
                ...
                for i = 1 : length(N_ind_n)
                    ...
                    for j = 1 : N_ind_n(i)
                        ...
                        if t_or_nt <= q_n       % Yes, the individual is treated
                            ...
                            [r_n] = Compute_prop_for_BP_det(fs, fr, mu1, N_R_n(i), N_bs, tau); % Compute the proportion of R bacteria after time tau in the naive individual
                            ...
                            N_R_growth_n = binornd(N_bs^2, real(r_n)); % Compute the number of R bacteria after time tau among the N_bs^2 bacteria in the naive individual
                            ...
                            if k_n ~= 0     % He/she contaminates at least one individual
                                ...
                                for q = 1 : k_n
                                    ...
                                    else % The contaminated individual is immmune
            ...
            % Let us consider the immune contaminating individual
                ...
                for i = 1 : length(N_ind_i)
                    ...
                    for j = 1 : N_ind_i(i)
                        ...
                        if t_or_nt <= q_i       % Yes, the individual is treated
                            ...
                            [r_i] = Compute_prop_for_BP_det(fs, fr, mu1, N_R_i(i), N_bs, tau); % Compute the proportion of R bacteria after time tau in the immune individual
                             ...
                             N_R_growth_i = binornd(N_bs, real(r_i));                    % Compute the number of R bacteria after time tau among the N_bs^2 bacteria in the immune individual                      
